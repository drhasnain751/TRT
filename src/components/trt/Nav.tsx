    ...
    >
      <div className="container-x flex h-16 md:h-20 items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1">
          ...
          <Link
            to="/membership"
            className="ml-3 inline-flex items-center gap-2 bg-trt-red px-5 py-2.5 text-[11px] uppercase tracking-[0.18em] font-semibold hover:bg-white hover:text-black transition-colors"
          >
            Join TRT
          </Link>
        </nav>
